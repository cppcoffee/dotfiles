...
cmd([[ autocmd FileType lua setlocal tabstop=4 shiftwidth=4 softtabstop=4 expandtab textwidth=80 ]])
...
cmd([[ autocmd FileType go setlocal tabstop=4 shiftwidth=4 softtabstop=4 textwidth=80 expandtab ]])
